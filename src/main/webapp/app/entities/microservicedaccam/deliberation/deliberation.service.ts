...
export class DeliberationService {
  ...
  changeDeliberationStatusetatMarche(deliberation: IDeliberation): Observable<EntityResponseType> {
    return this.http.put<IDeliberation>(this.resourceUrl + '/active-deliberation-etatMarche', deliberation, {observe: 'response'});
  }
}
