...
public class UserDTO {
    ...
    public UserDTO(User user) {
        ...
        this.idUniteAdmin = user.getIdUniteAdmin();
        ...
        this.passChange = user.getPassChange();
    }
    ...
    public Long getIdUniteAdmin() {
        return idUniteAdmin;
    }

    public void setIdUniteAdmin(Long idUniteAdmin) {
        this.idUniteAdmin = idUniteAdmin;
    }
