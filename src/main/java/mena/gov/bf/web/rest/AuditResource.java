...
import mena.gov.bf.service.AuditEventService;
...
public class AuditResource {
    ...
    /* @GetMapping("/find-login")
     public ResponseEntity<List<User>> findArboresc(@RequestParam String login) {
         return ResponseEntity.ok(auditEventService.findUser(login));
     }*/
   /* @GetMapping("/find-login")
    public ResponseEntity<List<User>> findistinctUser() {
        return ResponseEntity.ok(auditEventService.finddistinctUser());
    }*/
    @GetMapping("/find-principal")
    public ResponseEntity<List<AuditEvent>> findArborsc(@RequestParam String principal) {
        return ResponseEntity.ok(auditEventService.findByUser(principal));
    }

    @GetMapping("/find-type")
    public ResponseEntity<List<AuditEvent>> findArbores(@RequestParam String type) {
        return ResponseEntity.ok(auditEventService.findByStatus(type));
    }
}
